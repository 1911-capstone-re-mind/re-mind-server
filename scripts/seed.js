...
const activitiesSeed = [
  {
    name: 'posture',
    description: 'Good posture is about more than standing up straight so you can look your best. It is an important part of your long-term health. Making sure that you hold your body the right way can prevent pain, injuries, and other health problems.',
    frequency: 30,
    duration: 0
  },
  {
    name: 'movement',
    description: 'Sitting too much can contribute to health problems. Being less sedentary can lead to lower blood pressure, increased energy, and reduced risk of cardiovascular disease.',
    frequency: 60,
    duration: 1
  },
  {
    name: 'eye strain',
    description: 'Every 20 minutes, look at something 20 feet away for 20 seconds. The 20/20/20 rule was popularized by Dr. Jeff Anshell, a specialist in “vision ergonomics.”',
    frequency: 20,
    duration: 20
  },
  {
    name: 'hydration',
    description: 'Water is your body\'s principal chemical component and makes up about 60 percent of your body weight. Your body depends on water to survive. Lack of water can lead to dehydration — a condition that occurs when you don\'t have enough water in your body to carry out normal functions. Even mild dehydration can drain your energy and make you tired.',
    frequency: 30,
    duration: 0
  },
  {
